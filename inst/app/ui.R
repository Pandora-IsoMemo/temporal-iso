    ...
    tabPanel("Model",
             ...
             fluidRow(
               ...
               sidebarPanel(
                 ...
                 tags$hr(),
                 helpText("Please, save inputs and model before the download. (No automatic updates of fields.)"),
                 selectInput("selectedModels", label = "Download model object(s)",
                             choices = c("Save or upload inputs/models ..." = ""),
                             multiple = T),
                   ...
                   header = tagList(
                     ...
                     fluidRow(
                       ...
                       column(width = 3,
                              ...
                              selectInput("savedModels", 
                                          label = "Load inputs/model",
                                          choices = NULL)),
                       column(width = 1, 
